...
<p className=" text-2xl mb-3 md:text-3xl font-bold ">
      ...
      <div className="flex flex-col">
        <p className="font-bold text-xl">Children education need for the change the world </p>
        <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Fugiat exercitationem quod incidunt placeat laborum. Repellendus, repudiandae error, quae nam esse possimus est illum, autem nisi voluptatum molestiae dolores doloremque inventore.</p>
